          ...
          <FieldGroup className="gap-4">
            ...
            <Field>
              ...
              <select
                ...
                required
                defaultValue=""
                className="h-9 w-full rounded-lg border border-input bg-input/20 px-3 text-sm outline-none transition-colors focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/30 dark:bg-input/30"
              >
